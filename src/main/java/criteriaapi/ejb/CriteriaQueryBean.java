...
import criteriaapi.model.Aula;
import criteriaapi.model.Aula_;
import criteriaapi.model.Curso;
import criteriaapi.model.Curso_;
import criteriaapi.model.Modulo;
import criteriaapi.model.Modulo_;
...
@Singleton
@Startup
public class CriteriaQueryBean {
	
	// Adiciona uma pasta no JavaBuilderPath - Project settings > Java Build Path > Source > Add ... Create new folder
	// Alterar o Source folder para a pasta criada - Project settings > JPA > Canonical metamodel
